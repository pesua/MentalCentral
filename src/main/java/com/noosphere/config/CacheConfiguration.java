...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.noosphere.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.noosphere.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.noosphere.domain.Visit.class.getName());
